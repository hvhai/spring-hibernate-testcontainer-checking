...
import com.codehunter.springhibernatetestcontainerchecking.core.usecase.HikariUseCase;
...
public class ProducerController {
    ...
    private final HikariUseCase hikariUseCase;
    ...
    @GetMapping(path = "/hikari")
    ResponseEntity<Void> exhaustHikari() {
        hikariUseCase.exhaustHikari();
        return ResponseEntity.ok().build();
    }
}
